        ...
        <div class="col-md-3" >
          <ul class="list-group menuDashboard" >
            ...
            <a href="<?php echo base_url ('index.php/Dashboard/');?>" > <li style="margin-top: 10%;" class="list-group-item"><i class="fas fa-user" ></i>Profilku</li> </a>
                  <a href="<?php echo base_url ('index.php/Dashboard/cairkan'); ?>"> <li class="list-group-item <?php if($this->uri->segment(2)=="cairkan"){echo " active";}?>"><i class="fas fa-money-bill"></i>Cairkan Dana</li></a>
