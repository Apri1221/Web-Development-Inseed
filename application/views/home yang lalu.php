  ...
  <body id="page-top">
    ...
    <section id="header">
      <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <a href="<?php echo base_url()."index.php/welcome/index"; ?>"><img src="<?php echo base_url('asset/assets/image/logo.png');?>" style="  padding: 0 20px 0 20px;
          height: 75px;
        width: 250px;"></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-4 col-md-12 col-sm-12 col-xs-12 logo_footer">
          <a href="{{URL::to('welcome')}}"><img src="<?php echo base_url('asset/assets/image/logo.png');?>" style="width: 280px; height: auto;"></a>
