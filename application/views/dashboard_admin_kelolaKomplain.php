        ...
        <div class="col-md-3" >
          <ul class="list-group menuDashboard" >
            ...
            <div id="sidebarAdmin" >
              ...
              <a href="<?php echo base_url ('index.php/Dashboard/adminKomplain'); ?>"> <li class="list-group-item active"><i class="glyphicon glyphicon-search"></i>Laporkan Komplain</li></a>
            </div>
